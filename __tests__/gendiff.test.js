...
test.skip('checking stylish formatter with files of different extensions', () => {
  expect(
    gendiff(
...
test.skip("checking stylish formatter with files with '.json' extensions", () => {
  expect(
    gendiff(
...
test.skip("checking stylish formatter with files with '.yaml' extensions", () => {
  expect(
    gendiff(
      absolutePath('__fixtures__/newfile3.yaml'),
